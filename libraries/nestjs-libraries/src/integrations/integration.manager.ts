...
// AlchemyAI: commented networks are disabled to reduce Temporal worker overhead.
// Each provider spawns a Temporal worker (~2.86MB webpack bundle + heap).
// Uncomment as needed to re-enable.
